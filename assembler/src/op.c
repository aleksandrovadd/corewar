...
/*   Updated: 2018/03/11 18:51:32 by bsemchuk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_op	g_op_tab[17] =
{
	...
	{"xor", 3, {T_REG | T_IND | T_DIR, T_REG | T_IND | T_DIR, T_REG},
		8, 6, "ou (xor  r1, r2, r3   r1^r2 -> r3", 1, 0, 4},
	...
	{.command = "end", .codage = 0, .opcode = 0, .argsmax = 0,
		.argsflags = {0, 0, 0, 0}, .ctostart = 0,
		.description = "notUsableCommand", .labelsize = 0, .last = 0}
};
